...
curl https://sourceforge.net/p/latex-macros-packages/wrapper-breakable/ci/master/tree/wrapper-breakable.sty?format=raw -o wrapper-breakable.sty
...
curl https://sourceforge.net/p/latex-macros-packages/env-bulletjournalpicture/ci/main/tree/env-bulletjournalpicture.sty?format=raw -o env-bulletjournalpicture.sty
