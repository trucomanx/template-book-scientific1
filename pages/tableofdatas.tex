...
\tcblistof[\section*]{\EnvDefinitionListingExt}{Lista de definições}
%----------------------------------------------------------------------------------------
%    LISTA DE TEOREMAS
%----------------------------------------------------------------------------------------
\phantomsection
\addcontentsline{toc}{section}{Lista de teoremas} %% Sale en la pagina contents
\tcblistof[\section*]{\EnvTheoremListingExt}{Lista de teoremas}
...
%----------------------------------------------------------------------------------------
\phantomsection
\addcontentsline{toc}{section}{Lista de lemmas} %% Sale en la pagina contents
\tcblistof[\section*]{\EnvLemmaListingExt}{Lista de lemmas}
...
\tcblistof[\section*]{\EnvNotationListingExt}{Lista de notações}
...
\tcblistof[\section*]{\EnvExampleListingExt}{Lista de exemplos}
%----------------------------------------------------------------------------------------
%    LISTA DE EXERCICIOS
%----------------------------------------------------------------------------------------
\phantomsection
\addcontentsline{toc}{section}{Lista de exercicíos} %% Sale en la pagina contents
\tcblistof[\section*]{\EnvExerciseListingExt}{Lista de exercicíos}
...
\tcblistof[\section*]{\EnvInformationBoxListingExt}{Lista de informações}
%----------------------------------------------------------------------------------------
...
\tcblistof[\section*]{\EnvElaborationBoxListingExt}{Lista de elaborações}
...
\tcblistof[\section*]{\EnvPhraseBoxListingExt}{Lista de frases}
