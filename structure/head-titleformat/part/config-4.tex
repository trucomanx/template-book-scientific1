...
\draw[colorPartText!70]($(ptopleft)+(\i,0)$)--+(0,-\paperheight);
\node[white,fill=colorPartText,minimum size=1.5cm](A) at ($(ptopleft)+(1,-5)$){\fontsize{40pt}{0pt}\sffamily\selectfont\thepart};
\node [anchor=south,ultra thick,yshift=-1mm]at(A.north){\fontsize{40pt}{0pt}\sffamily\selectfont\partname};
