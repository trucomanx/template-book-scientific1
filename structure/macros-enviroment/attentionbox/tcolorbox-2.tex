...
ArcLength=3mm,
LeftRuleLength=3mm,
LeftRuleColor=colorAttention!50!black,
ImageObject={\hspace{-0.5pt}\textcolor{white}{\Huge\bfseries!}},
...
\newtcolorbox{attentionbox}[1][]{enhanced,
  before skip=\EnvAttentionBoxBeforeSpace,
  after skip=\EnvAttentionBoxAfterSpace,
  boxrule=0.4pt,
