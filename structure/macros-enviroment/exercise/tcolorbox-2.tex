...
\path[fill=colorsystemdefault!30!black]
([yshift=-1mm,xshift=-1mm]frame.north west)
arc[start angle=0,end angle=180,radius=1mm]
([yshift=-1mm,xshift=1mm]frame.north east)
arc[start angle=180,end angle=0,radius=1mm];
\path[left color=colorsystemdefault!60!black,right color=colorsystemdefault!60!black,middle color=colorsystemdefault!80!black]
