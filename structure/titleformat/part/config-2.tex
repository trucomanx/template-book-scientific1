...
{\addvspace{15pt}\large\bfseries\color{colorDefault}} % Spacing and font options for chapters % Acima do título
{\color{colorDefault}\contentslabel[\large\thecontentslabel]{1.25cm}\color{colorDefault}} % Chapter number % Antes do título
